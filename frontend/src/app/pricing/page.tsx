...
const PLANS = [
  {
    ...
    monthlyPrice: 0,
    yearlyPrice: 0,
    description: "For individuals, NGOs, and students exploring AI emergency response.",
    features: [
      { text: "Up to 10 emergency reports/month", included: true },
      { text: "Image and text incident reporting", included: true },
      { text: "Basic AI severity analysis", included: true },
      { text: "7-day event history", included: true },
      { text: "3 AI voice call alerts", included: true },
      { text: "Green corridor routing", included: false },
      { text: "Multi-department coordination", included: false },
      { text: "Admin rule injection", included: false },
  ...
  },
  {
    ...
    monthlyPrice: 49,
    yearlyPrice: 39,
    description: "For hospitals, private ambulance operators, and local response teams.",
    features: [
      { text: "75 emergency events/month", included: true },
      { text: "Image, text, and voice input", included: true },
      { text: "Full AI pipeline (CNN + LLM analysis)", included: true },
      { text: "AI voice calls to 5 departments per event", included: true },
      { text: "Green corridor (up to 5/month)", included: true },
      { text: "90-day event history", included: true },
      { text: "Email support", included: true },
      { text: "AI voice calls to 3+ departments", included: false },
      { text: "Unlimited green corridors", included: false },
      { text: "Admin rule injection", included: false },
  ...
  },
  {
    ...
    monthlyPrice: 199,
    yearlyPrice: 159,
    description: "For district hospitals, highway operators, and municipalities.",
    features: [
      { text: "400 emergency events/month", included: true },
      { text: "All input types including camera API", included: true },
      { text: "Full AI pipeline with priority processing", included: true },
      { text: "AI voice calls to 3 departments simultaneously", included: true },
      { text: "Unlimited green corridors", included: true },
      { text: "Full analytics dashboard", included: true },
      { text: "Admin rule injection (live, no restart)", included: true },
      { text: "Adaptation learning module", included: true },
      { text: "Priority chat + email support", included: true },
      { text: "Live CCTV feed integration", included: false },
      { text: "White-label deployment", included: false },
    ...
    <>
      ...
      <main style={{ flex: 1, padding: "64px 24px" }}>
        ...
        >
          ...
          <br />
          Overage pricing available — $0.50/event beyond plan limits.
        </motion.p>
      </main>
    </>
  );
